        ...
        <div className="text-center font-bold text-white pb-[4rem] text-[15rem] pt-[10rem] flex flex-col gap-2 justify-center w-full  items-center gap-y-10">
          <div className="flex md:inline-flex flex-col md:flex-row items-center">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              width="50"
              className="text-pink-500 animate-heartbeat animate-bounce"
            >
              <path
          ...
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4">
      ...
      <footer className="container mx-auto max-w-7xl pb-12 px-12">
        <div className="flex flex-col justify-center items-center gap-1">
          ...
          <Link
            ...
            target="_blank"
          >
            <p className="font-normal text-white">Deployed on</p>
            <svg
              fill="none"
              height="18"
